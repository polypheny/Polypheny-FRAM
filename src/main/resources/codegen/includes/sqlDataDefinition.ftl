<#--
// !! THIS FILE WAS ORIGINALLY NAMED "parserImpls.ftl"
//
// !! This file is based on code from the Apache Calcite project which is released under the Apache License, Version 2.0.
// !! Modifications are clearly marked and released under the Apache License, Version 2.0.
//
//
// LICENCE OF THE ORIGINAL FILE:
//
