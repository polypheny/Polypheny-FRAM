 ...
 */
public class SqlRollback extends SqlCtrl {

    private static final SqlOperator OPERATOR = new SqlSpecialOperator( "ROLLBACK", SqlKind.ROLLBACK );


    public SqlRollback( SqlParserPos pos ) {
        super( OPERATOR, pos );
    }
